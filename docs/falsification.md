...
| **AI** | QECC on non-TFIM chains | XX (n=8) and Heisenberg (n=6 tuned): `codeSubspaceFound` and `fidelitySelectivity` > 1.1 |
| **AJ** | Grid modular-flow clock network not globally consistent | 3×3 grid: `minPairwiseR² < 0.95` (uniform-inclusive network) |
| **AK** | Eigenvalue-only blind inference cannot recover labeling | {Eₙ}-only: 0/N recovered, flat scores; spectrum+ψ control recovers |
...
| **AN** | AA-blind fails on gapless XX chain; TFIM control passes | tfim n=6 h=1.5 recovers; xx n=6 h=0.5 does **not** recover; top-20 score spread < 0.02 (flat MI landscape) |
...
**K**, **L**, **L′**, **O**, **P**, **Q**, **AD**, **AE**, **AF**, **AG**, **AH**, **AI**, **AJ**, **AK**, **R′**, **F′**, **C′**, **I′**, **S′**, **T′**, **U′**, **V′**, **W′**, **X**, **Y**, **Z**, **AA**, **AL**, **AM**, **AN**, **AB**, **AC**, and **M** target [roadmap.md](./roadmap.md) signatures **S1**, **S4**, **S5**, **S6–S8**, **S9**, and **S10**.
...
**AB** and **AC** run via `npm run bench:factor` (not yet in the main 36-test battery).
